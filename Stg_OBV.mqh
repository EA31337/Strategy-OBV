...
class Stg_OBV : public Strategy {
 public:
  ...
  static Stg_OBV *Init_M1() {
    ...
    StgParams obv1_sparams(new Trade(PERIOD_M1, _Symbol), new Indi_OBV(obv1_iparams, obv_iparams, cparams1), NULL,
                           NULL);
    obv1_sparams.SetSignals(OBV1_SignalMethod, OBV1_OpenCondition1, OBV1_OpenCondition2, OBV1_CloseCondition, NULL,
                            OBV_SignalLevel, NULL);
  ...
  static Stg_OBV *Init_M5() {
    ...
    StgParams obv5_sparams(new Trade(PERIOD_M5, _Symbol), new Indi_OBV(obv5_iparams, obv_iparams, cparams5), NULL,
                           NULL);
    obv5_sparams.SetSignals(OBV5_SignalMethod, OBV5_OpenCondition1, OBV5_OpenCondition2, OBV5_CloseCondition, NULL,
                            OBV_SignalLevel, NULL);
  ...
  static Stg_OBV *Init_M15() {
    ...
    StgParams obv15_sparams(new Trade(PERIOD_M15, _Symbol), new Indi_OBV(obv15_iparams, obv_iparams, cparams15), NULL,
                            NULL);
    obv15_sparams.SetSignals(OBV15_SignalMethod, OBV15_OpenCondition1, OBV15_OpenCondition2, OBV15_CloseCondition, NULL,
                             OBV_SignalLevel, NULL);
  ...
  static Stg_OBV *Init_M30() {
    ...
    StgParams obv30_sparams(new Trade(PERIOD_M30, _Symbol), new Indi_OBV(obv30_iparams, obv_iparams, cparams30), NULL,
                            NULL);
    obv30_sparams.SetSignals(OBV30_SignalMethod, OBV30_OpenCondition1, OBV30_OpenCondition2, OBV30_CloseCondition, NULL,
                             OBV_SignalLevel, NULL);
